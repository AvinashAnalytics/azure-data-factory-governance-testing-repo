...
class ADF_Dashboard:
    ...
    def render_main_content_with_tabs(self):
        ...
        # Main tabs
        tab_labels = ["⚙️ Generate Excel", "📊 Upload & Analyze", "🤖 AI Chat", "🧠 ChatGPT", "💰 Cost Analysis", "📚 Documentation"]
        ...
        with main_tabs[4]:
            if HAS_COST_TAB:
                ...
                st.warning("⚠️ Cost Analysis module not available. Ensure `api_cost_engine.py` is in the project directory.")
